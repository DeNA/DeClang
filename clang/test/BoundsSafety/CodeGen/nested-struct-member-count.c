...
// CHECK-NEXT:    br i1 [[TMP11]], label %[[CONT9:.*]], label %[[TRAP8:.*]], !annotation [[META3]]
// CHECK:       [[TRAP8]]:
...
// CHECK-NEXT:    br i1 [[TMP11]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[CONT40:.*]], !annotation [[META4]]
...
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT36:.*]], label %[[TRAP35:.*]], !annotation [[META10]]
// CHECK:       [[TRAP35]]:
...
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT38:.*]], label %[[TRAP37:.*]], !annotation [[META10]]
// CHECK:       [[TRAP37]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT38]]:
// CHECK-NEXT:    [[TMP15:%.*]] = icmp uge ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_LB34]], !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP15]], label %[[CONT40]], label %[[TRAP39:.*]], !annotation [[META3]]
// CHECK:       [[TRAP39]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT40]]:
...
// CHECK-NEXT:    [[HDR:%.*]] = getelementptr inbounds [[STRUCT_OUTER]], ptr [[TMP16]], i32 0, i32 0
// CHECK-NEXT:    [[LEN41:%.*]] = getelementptr inbounds [[STRUCT_INNER:%.*]], ptr [[HDR]], i32 0, i32 1
...
// CHECK-NEXT:    br i1 [[TMP18]], label %[[BOUNDSCHECK_NOTNULL43:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL43]]:
// CHECK-NEXT:    [[FAM44:%.*]] = getelementptr inbounds [[STRUCT_OUTER]], ptr [[TMP17]], i32 0, i32 1
// CHECK-NEXT:    [[ARRAYDECAY45:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM44]], i64 0, i64 0
// CHECK-NEXT:    [[HDR46:%.*]] = getelementptr inbounds [[STRUCT_OUTER]], ptr [[TMP17]], i32 0, i32 0
// CHECK-NEXT:    [[LEN47:%.*]] = getelementptr inbounds [[STRUCT_INNER]], ptr [[HDR46]], i32 0, i32 1
...
// CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 0
// CHECK-NEXT:    store ptr [[TMP17]], ptr [[TMP20]], align 8
// CHECK-NEXT:    [[TMP21:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 1
// CHECK-NEXT:    store ptr [[ADD_PTR]], ptr [[TMP21]], align 8
// CHECK-NEXT:    [[TMP22:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 2
// CHECK-NEXT:    store ptr [[TMP17]], ptr [[TMP22]], align 8
// CHECK-NEXT:    br label %[[BOUNDSCHECK_CONT:.*]]
// CHECK:       [[BOUNDSCHECK_NULL]]:
// CHECK-NEXT:    [[TMP23:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 0
// CHECK-NEXT:    store ptr null, ptr [[TMP23]], align 8
// CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 1
// CHECK-NEXT:    store ptr null, ptr [[TMP24]], align 8
// CHECK-NEXT:    [[TMP25:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 2
// CHECK-NEXT:    store ptr null, ptr [[TMP25]], align 8
// CHECK-NEXT:    br label %[[BOUNDSCHECK_CONT]]
// CHECK:       [[BOUNDSCHECK_CONT]]:
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR48:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR49:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR48]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR50:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB51:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR50]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR52:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP42]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB53:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR52]], align 8
// CHECK-NEXT:    [[TMP26:%.*]] = icmp ne ptr [[WIDE_PTR_PTR49]], null, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP26]], label %[[BOUNDSCHECK_NOTNULL54:.*]], label %[[CONT60:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL54]]:
// CHECK-NEXT:    [[TMP27:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR49]], i64 1, !annotation [[META10]]
// CHECK-NEXT:    [[TMP28:%.*]] = icmp ule ptr [[TMP27]], [[WIDE_PTR_UB51]], !annotation [[META10]]
// CHECK-NEXT:    br i1 [[TMP28]], label %[[CONT56:.*]], label %[[TRAP55:.*]], !annotation [[META10]]
// CHECK:       [[TRAP55]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT56]]:
// CHECK-NEXT:    [[TMP29:%.*]] = icmp ule ptr [[WIDE_PTR_PTR49]], [[TMP27]], !annotation [[META10]]
// CHECK-NEXT:    br i1 [[TMP29]], label %[[CONT58:.*]], label %[[TRAP57:.*]], !annotation [[META10]]
// CHECK:       [[TRAP57]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META10]]
// CHECK-NEXT:    unreachable, !annotation [[META10]]
// CHECK:       [[CONT58]]:
// CHECK-NEXT:    [[TMP30:%.*]] = icmp uge ptr [[WIDE_PTR_PTR49]], [[WIDE_PTR_LB53]], !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP30]], label %[[CONT60]], label %[[TRAP59:.*]], !annotation [[META3]]
// CHECK:       [[TRAP59]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT60]]:
