...
// X86_64-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, ptr [[TMP0]], i64 [[IDX_EXT]]
// X86_64-NEXT:    [[TMP2:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP]], i32 0, i32 0
// X86_64-NEXT:    store ptr [[TMP0]], ptr [[TMP2]], align 8
// X86_64-NEXT:    [[TMP3:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP]], i32 0, i32 1
// X86_64-NEXT:    store ptr [[ADD_PTR]], ptr [[TMP3]], align 8
// X86_64-NEXT:    [[TMP4:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP]], i32 0, i32 2
...
// X86_64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr i32, ptr [[WIDE_PTR_PTR]], i64 1
...
// X86_64-NEXT:    [[TMP5:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, !annotation [[META2:![0-9]+]]
// X86_64-NEXT:    [[TMP6:%.*]] = icmp ule ptr [[TMP5]], [[WIDE_PTR_UB]], !annotation [[META2]]
...
// X86_64:       cont:
// X86_64-NEXT:    [[TMP7:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP5]], !annotation [[META2]]
// X86_64-NEXT:    br i1 [[TMP7]], label [[CONT2:%.*]], label [[TRAP1:%.*]], !annotation [[META2]]
// X86_64:       trap1:
// X86_64-NEXT:    call void @fb_trap(i8 25) #[[ATTR1]], !annotation [[META2]]
// X86_64-NEXT:    br label [[CONT2]], !annotation [[META2]]
// X86_64:       cont2:
// X86_64-NEXT:    [[TMP8:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META3:![0-9]+]]
// X86_64-NEXT:    br i1 [[TMP8]], label [[CONT4:%.*]], label [[TRAP3:%.*]], !annotation [[META3]]
// X86_64:       trap3:
// X86_64-NEXT:    call void @fb_trap(i8 25) #[[ATTR1]], !annotation [[META3]]
// X86_64-NEXT:    br label [[CONT4]], !annotation [[META3]]
// X86_64:       cont4:
// X86_64-NEXT:    [[TMP9:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
// X86_64-NEXT:    ret i32 [[TMP9]]
//
