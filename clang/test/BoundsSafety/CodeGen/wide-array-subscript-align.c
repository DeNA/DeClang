...
// CHECK:       cont:
// CHECK-NEXT:    [[LENGTH:%.*]] = getelementptr inbounds [[STRUCT_BSTR:%.*]], ptr [[TMP0]], i32 0, i32 1
...
// CHECK-NEXT:    unreachable, {{!nosanitize ![0-9]+}}
// CHECK:       cont4:
// CHECK-NEXT:    [[DATA:%.*]] = getelementptr inbounds [[STRUCT_BSTR]], ptr [[TMP0]], i32 0, i32 0
...
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i8, ptr [[TMP14]], i64 [[TMP7]]
