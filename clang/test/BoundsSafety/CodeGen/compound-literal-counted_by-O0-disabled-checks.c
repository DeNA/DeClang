...
// RUN: %clang_cc1 -O0 -triple arm64-apple-iphoneos -x objective-c  -emit-llvm -fexperimental-bounds-safety-objc -fbounds-safety -fno-bounds-safety-bringup-missing-checks=compound_literal_init -Wno-bounds-attributes-init-list-side-effect -o - %s | FileCheck %s
...
// CHECK-NEXT:    [[COUNT1:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[DOTCOMPOUNDLITERAL]], i32 0, i32 0
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[NEW_COUNT_ADDR]], align 4
// CHECK-NEXT:    store i32 [[TMP0]], ptr [[COUNT1]], align 8
// CHECK-NEXT:    [[BUF2:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[DOTCOMPOUNDLITERAL]], i32 0, i32 1
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP]], ptr align 8 [[NEW_PTR]], i64 24, i1 false)
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP]], i32 0, i32 1
...
// CHECK-NEXT:    call void @consume_cb([2 x i64] [[TMP1]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store i32 0, ptr [[OTHER]], align 8
// CHECK-NEXT:    [[COUNT1:%.*]] = getelementptr inbounds [[STRUCT_NESTED_AND_OUTER_CB]], ptr [[DOTCOMPOUNDLITERAL]], i32 0, i32 2
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[NEW_COUNT_ADDR]], align 4
// CHECK-NEXT:    store i32 [[TMP2]], ptr [[COUNT1]], align 4
// CHECK-NEXT:    [[BUF2:%.*]] = getelementptr inbounds [[STRUCT_NESTED_AND_OUTER_CB]], ptr [[DOTCOMPOUNDLITERAL]], i32 0, i32 3
...
// CHECK-NEXT:    [[COUNT1:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[ARRAYINIT_ELEMENT]], i32 0, i32 0
// CHECK-NEXT:    store i32 0, ptr [[COUNT1]], align 8
// CHECK-NEXT:    [[BUF2:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[ARRAYINIT_ELEMENT]], i32 0, i32 1
// CHECK-NEXT:    store ptr null, ptr [[BUF2]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = getelementptr [2 x %struct.cb], ptr [[ARR]], i64 1
...
// CHECK-NEXT:    [[COUNT1:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[TMP1]], i32 0, i32 0
...
// CHECK-NEXT:    [[COUNT2:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[TMP3]], i32 0, i32 0
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[COUNT2]], align 8
// CHECK-NEXT:    [[BUF3:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[TMP3]], i32 0, i32 1
...
// CHECK-NEXT:    call void @consume_cb([2 x i64] [[TMP6]])
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[BUF2:%.*]] = getelementptr inbounds [[STRUCT_CB]], ptr [[ARRAYINIT_ELEMENT]], i32 0, i32 1
// CHECK-NEXT:    store ptr null, ptr [[BUF2]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = getelementptr [2 x %struct.cb], ptr [[ARR]], i64 1
