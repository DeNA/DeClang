...
// CHECK:       [[LAND_RHS]]:
// CHECK-NEXT:    [[CONV:%.*]] = sext i32 [[COUNT]] to i64, !annotation [[META2]]
// CHECK-NEXT:    [[SUB_PTR_SUB:%.*]] = sub i64 [[P_COERCE_FCA_1_EXTRACT]], [[P_COERCE_FCA_0_EXTRACT]], !annotation [[META7]]
// CHECK-NEXT:    [[SUB_PTR_DIV:%.*]] = ashr exact i64 [[SUB_PTR_SUB]], 2, !annotation [[META2]]
...
// CHECK-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[TMP_SROA_9_0]], [[P]], !annotation [[META2]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[LAND_RHS:.*]], !annotation [[META2]]
// CHECK:       [[LAND_RHS]]:
...
// CHECK-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[AGG_TEMP_SROA_1_0_COPYLOAD]], [[END]], !annotation [[META2]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[LAND_LHS_TRUE:.*]], !annotation [[META2]]
// CHECK:       [[LAND_LHS_TRUE]]:
...
// CHECK-NEXT:    [[CMP:%.*]] = icmp uge ptr [[UPPER]], [[END]], !annotation [[META2]]
