...
int main(int argc, char **argv) {
  struct Foo f;
// CHECK:  [[LEN:%.*]] = getelementptr inbounds %struct.Foo, ptr [[STRUCT_F:%.*]], i32 0, i32 0
// CHECK:  store i32 0, ptr [[LEN]], align 8, !annotation ![[ANNOT_ZEROINIT:[0-9]+]]
// CHECK:  [[FOO_SINGLE_COUNTED_BY:%.*]] = getelementptr inbounds %struct.Foo, ptr [[STRUCT_F]], i32 0, i32 1
