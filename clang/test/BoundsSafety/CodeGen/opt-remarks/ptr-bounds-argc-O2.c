...
// IR-NEXT:   %[[UPPER_BOUND:[a-z0-9.]+]] = getelementptr inbounds i32, ptr %[[ARR:[a-z0-9.]+]], i64 %[[COUNT_EXT]], !dbg ![[LOC_10_5]]
...
// IR-NEXT: br i1 %[[COND_AND_1]], label %[[FOO_LABEL_CONT:[a-z0-9]+]], label  %[[FOO_LABEL_TRAP:[a-z0-9]+]], !dbg ![[LOC_10_16]], !annotation ![[ANNOT_LE_UB]]
