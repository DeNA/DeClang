...
// IR-NEXT: br i1 %7, label %[[FOO_LABEL_CONT_0:[a-z0-9]+]], label %[[FOO_LABEL_TRAP_0:[a-z0-9]+]], !dbg ![[LOC_10_16]], !annotation ![[ANNOT_LE_UB]]
// ...
...
// IR-NEXT:   br i1 %8, label  %[[FOO_LABEL_CONT_1:[a-z0-9]+]], label %[[FOO_LABEL_TRAP_1:[a-z0-9]+]], !dbg !11, !annotation ![[ANNOT_LE_UB]]
...
// IR-NEXT: br i1 %{{.*}}, label %[[FOO_LABEL_CONT_2:[a-z0-9]+]], label %[[FOO_LABEL_TRAP_2:[a-z0-9]+]], !dbg !11, !annotation ![[ANNOT_GE_LB]]
