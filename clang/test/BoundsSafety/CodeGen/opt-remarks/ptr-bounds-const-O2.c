...
// IR: %[[UPPER_BOUND:.+]] = getelementptr inbounds i32, ptr %[[ARRAY:.+]], i64 %{{.+}}, !dbg !{{.+}}
...
// IR-NEXT: br i1 %[[COMBINED_CHECKS]], label %[[FOO_LABEL_CONT:[a-z0-9]+]], label %[[FOO_LABEL_TRAP:[a-z0-9]+]], !dbg ![[LOC_FOO]], !annotation ![[ANNOT_LE_UB]]
//
// IR: [[FOO_LABEL_TRAP]]:
