...
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_SROA_245_0__SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[PTR]], i64 8
// CHECK-NEXT:    store ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], ptr [[DOTCOMPOUNDLITERAL_SROA_245_0__SROA_IDX]], align 8, !tbaa [[TBAA3]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    tail call void @consume_sbon([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR6:[0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr nocapture noundef writeonly [[PTR:%.*]], i32 noundef [[NEW_COUNT:%.*]]) local_unnamed_addr #[[ATTR4:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK:       [[CONT95]]:
// CHECK-NEXT:    store i32 [[NEW_COUNT]], ptr [[PTR]], align 8, !tbaa [[TBAA9]]
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_SROA_2114_0__SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[PTR]], i64 8
// CHECK-NEXT:    store ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], ptr [[DOTCOMPOUNDLITERAL_SROA_2114_0__SROA_IDX]], align 8, !tbaa [[TBAA3]]
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_SROA_3_0__SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[PTR]], i64 16
// CHECK-NEXT:    store i32 0, ptr [[DOTCOMPOUNDLITERAL_SROA_3_0__SROA_IDX]], align 8, !tbaa [[TBAA9]]
...
// CHECK-NEXT:    [[BUF46:%.*]] = getelementptr inbounds i8, ptr [[ARR]], i64 24
// CHECK-NEXT:    store ptr null, ptr [[BUF46]], align 8, !tbaa [[TBAA14]]
// CHECK-NEXT:    call void @consume_sbon_arr(ptr noundef nonnull [[ARR]]) #[[ATTR6]]
...
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_SROA_245_0_BYVAL_TEMP_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[BYVAL_TEMP]], i64 8
// CHECK-NEXT:    store ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], ptr [[DOTCOMPOUNDLITERAL_SROA_245_0_BYVAL_TEMP_SROA_IDX]], align 8
...
// CHECK-NEXT:    [[BUF:%.*]] = getelementptr inbounds i8, ptr [[PTR]], i64 8
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[BUF]], align 8, !tbaa [[TBAA14]]
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[TMP1]], null, !annotation [[META19:![0-9]+]]
// CHECK-NEXT:    [[CMP_NOT51:%.*]] = icmp slt i32 [[TMP0]], 0
// CHECK-NEXT:    [[CMP_NOT:%.*]] = select i1 [[DOTNOT]], i1 [[CMP_NOT51]], i1 false, !annotation [[META2]]
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[NEW_PTR]], null, !annotation [[META19]]
// CHECK-NEXT:    [[CMP_NOT47:%.*]] = icmp slt i32 [[NEW_COUNT]], 0
// CHECK-NEXT:    [[CMP_NOT:%.*]] = and i1 [[CMP_NOT47]], [[DOTNOT]], !annotation [[META2]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[CONT:.*]], !annotation [[META2]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META2]]
// CHECK-NEXT:    unreachable, !annotation [[META2]]
...
// CHECK-NEXT:    store i32 [[NEW_COUNT]], ptr [[PTR]], align 8, !tbaa [[TBAA9]]
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_SROA_245_0__SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[PTR]], i64 8
// CHECK-NEXT:    store ptr [[NEW_PTR]], ptr [[DOTCOMPOUNDLITERAL_SROA_245_0__SROA_IDX]], align 8, !tbaa [[TBAA3]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[NEW_PTR]], null, !annotation [[META19]]
// CHECK-NEXT:    [[CMP_NOT49:%.*]] = icmp slt i32 [[NEW_COUNT]], 0
// CHECK-NEXT:    [[CMP_NOT:%.*]] = and i1 [[CMP_NOT49]], [[DOTNOT]], !annotation [[META2]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[CONT:.*]], !annotation [[META2]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META2]]
// CHECK-NEXT:    unreachable, !annotation [[META2]]
...
// CHECK-NEXT:    tail call void @consume_sbon([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR6]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[NEW_PTR]], null, !annotation [[META19]]
// CHECK-NEXT:    [[CMP_NOT47:%.*]] = icmp slt i32 [[NEW_COUNT]], 0
// CHECK-NEXT:    [[CMP_NOT:%.*]] = and i1 [[DOTNOT]], [[CMP_NOT47]], !annotation [[META2]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[CONT:.*]], !annotation [[META2]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META2]]
// CHECK-NEXT:    unreachable, !annotation [[META2]]
...
// CHECK: [[META13]] = !{!"sbon", [[META10]], i64 0, [[META4]], i64 8}
// CHECK: [[TBAA14]] = !{[[META13]], [[META4]], i64 8}
// CHECK: [[TBAA15]] = !{[[META16:![0-9]+]], [[META10]], i64 0}
// CHECK: [[META16]] = !{!"sbon_with_other_data", [[META10]], i64 0, [[META4]], i64 8, [[META10]], i64 16}
// CHECK: [[TBAA17]] = !{[[META16]], [[META4]], i64 8}
// CHECK: [[TBAA18]] = !{[[META16]], [[META10]], i64 16}
// CHECK: [[META19]] = !{!"bounds-safety-check-ptr-neq-null"}
//.
