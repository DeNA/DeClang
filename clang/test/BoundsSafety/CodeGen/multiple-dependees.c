...
// CHECK-NEXT:    [[CNT142:%.*]] = getelementptr inbounds [[STRUCT_T]], ptr [[AGG_TEMP41]], i32 0, i32 0
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[CNT142]], align 8
// CHECK-NEXT:    [[CNT243:%.*]] = getelementptr inbounds [[STRUCT_T]], ptr [[AGG_TEMP41]], i32 0, i32 1
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[CNT243]], align 4
// CHECK-NEXT:    [[PTR44:%.*]] = getelementptr inbounds [[STRUCT_T]], ptr [[AGG_TEMP41]], i32 0, i32 2
...
// CHECK-NEXT:    br i1 [[TMP15]], label [[CONT57:%.*]], label [[TRAP56:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap56:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont57:
