...
// CHECK-NEXT:    [[LEN16:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[AGG_TEMP15]], i32 0, i32 2
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[LEN16]], align 8
// CHECK-NEXT:    [[PTR217:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[AGG_TEMP15]], i32 0, i32 1
...
// CHECK-NEXT:    [[LEN17:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[AGG_TEMP16]], i32 0, i32 2
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[LEN17]], align 8
// CHECK-NEXT:    [[PTR18:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[AGG_TEMP16]], i32 0, i32 0
