...
// CHECK-NEXT:    [[COUNT:%.*]] = getelementptr inbounds [[STRUCT_FOO:%.*]], ptr [[TMP0]], i32 0, i32 0
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[COUNT]], align 8
// CHECK-NEXT:    [[BYTES:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[TMP0]], i32 0, i32 1
...
// CHECK-NEXT:    [[COUNT1:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[TMP15]], i32 0, i32 0
...
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR7:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP6]], i32 0, i32 2
...
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR18:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP17]], i32 0, i32 1
...
// CHECK-NEXT:    [[BYTES36:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[TMP18]], i32 0, i32 1
// CHECK-NEXT:    store ptr [[WIDE_PTR_PTR31]], ptr [[BYTES36]], align 8
// CHECK-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[F_ADDR]], align 8
// CHECK-NEXT:    [[COUNT37:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[TMP19]], i32 0, i32 0
