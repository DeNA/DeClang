...
// CHECK-NEXT:    [[ELEMS:%.*]] = getelementptr inbounds i8, ptr [[FLEX]], i64 4
...
// CHECK-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[AGG_TEMP2_SROA_3_0]], [[FLEX]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label [[BOUNDSCHECK_CONT:%.*]], label [[BOUNDSCHECK_NOTNULL:%.*]], {{!annotation ![0-9]+}}
// CHECK:       boundscheck.notnull:
// CHECK-NEXT:    [[ELEMS:%.*]] = getelementptr inbounds i8, ptr [[DEST]], i64 4
...
// CHECK-NEXT:    [[ELEMS6:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 4
...
// CHECK-NEXT:    [[CONV:%.*]] = zext i32 [[SIZE:%.*]] to i64
// CHECK-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[AGG_TEMP4_SROA_3_0]], [[SRC]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[CMP102_NOT:%.*]] = icmp ult ptr [[AGG_TEMP2_SROA_3_0]], [[DEST]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[ELEMS5:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[SRC]], align 4, {{!tbaa ![0-9]+}}
...
// CHECK-NEXT:    [[CONV:%.*]] = zext i32 [[SIZE:%.*]] to i64
// CHECK-NEXT:    [[CMP_NOT:%.*]] = icmp ult ptr [[AGG_TEMP3_SROA_3_0]], [[SRC]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[CMP101_NOT:%.*]] = icmp ult ptr [[AGG_TEMP1_SROA_3_0]], [[DEST]], {{!annotation ![0-9]+}}
