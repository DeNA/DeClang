...
// CHECK-NEXT:    tail call void @consume_sb([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR5:[0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call void @consume_sb_arr(ptr noundef nonnull [[ARR]]) #[[ATTR5]]
...
// CHECK-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [2 x i64] poison, i64 [[DOTCOMPOUNDLITERAL_SROA_0_0_INSERT_EXT]], 0
// CHECK-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [2 x i64] [[DOTFCA_0_INSERT]], i64 [[SUB_PTR_RHS_CAST]], 1
// CHECK-NEXT:    tail call void @consume_sb([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR5]]
// CHECK-NEXT:    ret void
//
