...
// CHECK-NEXT:    [[TMP2:%.*]] = icmp uge ptr [[TMP0]], [[PTR_COERCE0]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS_NOT]], label [[TRAP]], label [[CONT3]], {{!annotation ![0-9]+}}
// CHECK:       cont3:
...
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS_NOT]], label [[TRAP]], label [[CONT9]], {{!annotation ![0-9]+}}
// CHECK:       cont9:
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TERMINATED_BY_CUR_0]], align 4
// CHECK-NEXT:    [[TERMINATED_BY_CHECK_TERMINATOR:%.*]] = icmp eq i32 [[TMP3]], 0
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_TERMINATOR]], label [[TERMINATED_BY_LOOP_END:%.*]], label [[TERMINATED_BY_LOOP_COND]]
