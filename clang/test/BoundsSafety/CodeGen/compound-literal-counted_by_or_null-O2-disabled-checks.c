...
// CHECK-SAME: ptr nocapture noundef [[PTR:%.*]]) local_unnamed_addr #[[ATTR1]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    ret void
//
...
// CHECK: [[META9]] = !{!"cbon", [[META3]], i64 0, [[META7]], i64 8}
// CHECK: [[TBAA10]] = !{[[META9]], [[META7]], i64 8}
// CHECK: [[TBAA11]] = !{[[META12:![0-9]+]], [[META3]], i64 0}
// CHECK: [[META12]] = !{!"cbon_with_other_data", [[META3]], i64 0, [[META7]], i64 8, [[META3]], i64 16}
