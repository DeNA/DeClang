...
// CHECK-NEXT:    tail call void @consume_cbon([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR6:[0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call void @consume_cbon_arr(ptr noundef nonnull [[ARR]]) #[[ATTR6]]
...
// CHECK-NEXT:    tail call void @consume_cbon([2 x i64] [[DOTFCA_1_INSERT]]) #[[ATTR6]]
// CHECK-NEXT:    ret void
//
...
// CHECK: [[META13]] = !{!"cbon", [[META10]], i64 0, [[META4]], i64 8}
// CHECK: [[TBAA14]] = !{[[META13]], [[META4]], i64 8}
// CHECK: [[TBAA15]] = !{[[META16:![0-9]+]], [[META10]], i64 0}
// CHECK: [[META16]] = !{!"cbon_with_other_data", [[META10]], i64 0, [[META4]], i64 8, [[META10]], i64 16}
