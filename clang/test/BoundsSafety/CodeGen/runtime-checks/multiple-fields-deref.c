...
// CHECK-NEXT:    [[B:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], i64 4
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[B]], align 4, {{!tbaa ![0-9]+}}
// CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP4]], [[TMP3]]
// CHECK-NEXT:    [[C:%.*]] = getelementptr inbounds i8, ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], i64 8
