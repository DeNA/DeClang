...
// O0-NEXT:    [[TMP8:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[BP]], i32 0, i32 0
// O0-NEXT:    store ptr [[TMP6]], ptr [[TMP8]], align 8
// O0-NEXT:    [[TMP9:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[BP]], i32 0, i32 1
// O0-NEXT:    store ptr [[ADD_PTR]], ptr [[TMP9]], align 8
// O0-NEXT:    [[TMP10:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[BP]], i32 0, i32 2
...
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       cont26:
// O0-NEXT:    [[TMP15:%.*]] = load i32, ptr [[WIDE_PTR_PTR16]], align 4
