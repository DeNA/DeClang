...
// CHECK-O0-NEXT:    [[TMP18:%.*]] = getelementptr i32, ptr [[WIDE_PTR_PTR8]], i64 1, {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    [[TMP19:%.*]] = icmp ule ptr [[TMP18]], [[WIDE_PTR_UB10]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP19]], label [[CONT14:%.*]], label [[TRAP13:%.*]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap13:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont14:
// CHECK-O0-NEXT:    [[TMP20:%.*]] = icmp ule ptr [[WIDE_PTR_PTR8]], [[TMP18]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP20]], label [[CONT16:%.*]], label [[TRAP15:%.*]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap15:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont16:
// CHECK-O0-NEXT:    [[TMP21:%.*]] = icmp uge ptr [[WIDE_PTR_PTR8]], [[WIDE_PTR_LB12]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP21]], label [[CONT18:%.*]], label [[TRAP17:%.*]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap17:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont18:
// CHECK-O0-NEXT:    [[TMP22:%.*]] = load i32, ptr [[WIDE_PTR_PTR8]], align 4
// CHECK-O0-NEXT:    ret i32 [[TMP22]]
//
// CHECK-O2-LABEL: @main(
// CHECK-O2-NEXT:  entry:
...
// CHECK-ARM-O2-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR2:[0-9]+]], {{!annotation ![0-9]+}}
