...
// O0-NEXT:    br i1 [[TMP22]], label [[CONT:%.*]], label [[TRAP:%.*]], {{!annotation ![0-9]+}}
// O0:       trap:
...
// O0-NEXT:    br i1 [[TMP23]], label [[CONT4:%.*]], label [[TRAP3:%.*]], {{!annotation ![0-9]+}}
// O0:       trap3:
...
// O0-NEXT:    br i1 [[TMP24]], label [[CONT6:%.*]], label [[TRAP5:%.*]], {{!annotation ![0-9]+}}
// O0:       trap5:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       cont6:
