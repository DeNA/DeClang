...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[LEN:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 8
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[BOUND_PTR_ARITH]], align 4, !tbaa [[TBAA9]]
...
// CHECK-NEXT:    br i1 [[OR_COND43]], label [[CONT36]], label [[TRAP:%.*]], !annotation [[META12]]
// CHECK:       cont36:
