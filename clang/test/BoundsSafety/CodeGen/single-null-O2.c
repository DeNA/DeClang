...
// CHECK-O2-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 1
...
// CHECK-O2-NEXT:    br i1 [[OR_COND]], label [[CONT30:%.*]], label [[TRAP:%.*]], !annotation [[META2]]
// CHECK-O2:       trap:
// CHECK-O2-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5:[0-9]+]], !annotation [[META3:![0-9]+]]
// CHECK-O2-NEXT:    unreachable, !annotation [[META3]]
// CHECK-O2:       cont30:
