...
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR24:%.*]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP23]], i32 0, i32 1, {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[BUF43:%.*]] = getelementptr inbounds [[STRUCT_PACKET]], ptr [[P]], i32 0, i32 0
// CHECK-NEXT:    store ptr [[WIDE_PTR_PTR38]], ptr [[BUF43]], align 8
// CHECK-NEXT:    [[LEN44:%.*]] = getelementptr inbounds [[STRUCT_PACKET]], ptr [[P]], i32 0, i32 1
