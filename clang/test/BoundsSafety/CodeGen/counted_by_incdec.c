...
// CHECK-NEXT:    [[BUF:%.*]] = getelementptr inbounds [[STRUCT_ITEM:%.*]], ptr [[TMP0]], i32 0, i32 0
// CHECK-NEXT:    [[LEN:%.*]] = getelementptr inbounds [[STRUCT_ITEM]], ptr [[TMP0]], i32 0, i32 1
...
// CHECK-NEXT:    [[LEN1:%.*]] = getelementptr inbounds [[STRUCT_ITEM]], ptr [[TMP15]], i32 0, i32 1
...
// CHECK-NEXT:    [[INCDEC_PTR:%.*]] = getelementptr inbounds i32, ptr [[TMP18]], i32 1
