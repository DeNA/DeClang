...
// CHECK-NEXT:    [[Q:%.*]] = getelementptr inbounds [[STRUCT_BAR:%.*]], ptr [[TMP0]], i32 0, i32 0
...
// CHECK-NEXT:    [[SIZE:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP2]], i32 0, i32 1
...
// CHECK-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[SIZE:%.*]] = getelementptr inbounds [[STRUCT_BAR:%.*]], ptr [[TMP0]], i32 0, i32 1
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[SIZE]], align 8
// CHECK-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP1]], 42
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[SIZE1:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP2]], i32 0, i32 1
// CHECK-NEXT:    store i32 [[SUB]], ptr [[SIZE1]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[Q:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP3]], i32 0, i32 0
...
// CHECK-NEXT:    [[Q2:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP5]], i32 0, i32 0
