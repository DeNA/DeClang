...
// CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[F]], i32 0, i32 0
// CHECK-NEXT:    store ptr null, ptr [[PTR]], align 8, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[COUNT:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[F]], i32 0, i32 1
// CHECK-NEXT:    store i32 0, ptr [[COUNT]], align 8, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[COUNT1:%.*]] = getelementptr inbounds [[STRUCT_FOO]], ptr [[F]], i32 0, i32 1
