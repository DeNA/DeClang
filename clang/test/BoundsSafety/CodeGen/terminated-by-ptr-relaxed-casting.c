...
// CHECK-NEXT:    br i1 [[TMP13]], label [[CONT:%.*]], label [[TRAP:%.*]], !annotation [[META3]]
// CHECK:       trap:
...
// CHECK-NEXT:    br i1 [[TMP14]], label [[CONT2:%.*]], label [[TRAP1:%.*]], !annotation [[META3]]
// CHECK:       trap1:
...
// CHECK-NEXT:    br i1 [[TMP15]], label [[CONT4]], label [[TRAP3:%.*]], !annotation [[META4]]
// CHECK:       trap3:
