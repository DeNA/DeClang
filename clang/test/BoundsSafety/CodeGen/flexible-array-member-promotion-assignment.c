...
// CHECK-NEXT:    br i1 [[TMP22]], label [[CONT44:%.*]], label [[TRAP43:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap43:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont44:
// CHECK-NEXT:    [[TMP23:%.*]] = icmp ule ptr [[WIDE_PTR_PTR37]], [[TMP21]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP23]], label [[CONT46:%.*]], label [[TRAP45:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap45:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont46:
// CHECK-NEXT:    [[TMP24:%.*]] = icmp uge ptr [[WIDE_PTR_PTR37]], [[WIDE_PTR_LB41]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP24]], label [[CONT48]], label [[TRAP47:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap47:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont48:
...
// CHECK-NEXT:    br i1 [[TMP18]], label [[CONT32:%.*]], label [[TRAP31:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap31:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont32:
// CHECK-NEXT:    [[TMP19:%.*]] = icmp ule ptr [[WIDE_PTR_PTR25]], [[TMP17]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP19]], label [[CONT34:%.*]], label [[TRAP33:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap33:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont34:
// CHECK-NEXT:    [[TMP20:%.*]] = icmp uge ptr [[WIDE_PTR_PTR25]], [[WIDE_PTR_LB29]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP20]], label [[CONT36]], label [[TRAP35:%.*]], {{!annotation ![0-9]+}}
// CHECK:       trap35:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont36:
...
// CHECK-NEXT:    [[COUNT37:%.*]] = getelementptr inbounds [[STRUCT_FLEX_T]], ptr [[TMP21]], i32 0, i32 0
