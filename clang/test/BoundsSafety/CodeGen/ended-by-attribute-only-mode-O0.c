...
// CHECK-NEXT:    [[END:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP2]], i32 0, i32 1
...
// CHECK-NEXT:    store ptr [[B]], ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[END:%.*]] = getelementptr inbounds [[STRUCT_BAR:%.*]], ptr [[TMP0]], i32 0, i32 1
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[END]], align 8
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, ptr [[TMP1]], i64 -42
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[B_ADDR]], align 8
// CHECK-NEXT:    [[END1:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP2]], i32 0, i32 1
...
// CHECK-NEXT:    [[Q3:%.*]] = getelementptr inbounds [[STRUCT_BAR]], ptr [[TMP5]], i32 0, i32 0
