...
// CHECK-LABEL: consume
// CHECK:  [[ADDR:%[-_.[:alnum:]]+]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[WIDE_PTR:%[-_.[:alnum:]]+]], i32 0, i32 0
// CHECK:  [[PTR:%[-_.[:alnum:]]+]] = load ptr, ptr [[ADDR]], align 8
// CHECK:  [[PTR_INDEXED:%[-_.[:alnum:]]+]] = getelementptr i8, ptr [[PTR]], i64 0
// CHECK:  [[UB_ADDR:%[-_.[:alnum:]]+]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[WIDE_PTR]], i32 0, i32 1
// CHECK:  [[UB:%[-_.[:alnum:]]+]] = load ptr, ptr [[UB_ADDR]], align 8
// CHECK:  [[LB_ADDR:%[-_.[:alnum:]]+]] = getelementptr inbounds %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[WIDE_PTR]], i32 0, i32 2
