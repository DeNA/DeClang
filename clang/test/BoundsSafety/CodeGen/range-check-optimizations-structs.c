...
// CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds [[STRUCT_STRUCT_1:%.*]], ptr [[SRC:%.*]], i64 [[IDX_EXT]]
...
// CHECK:       cont12:
// CHECK-NEXT:    [[B13:%.*]] = getelementptr inbounds i8, ptr [[BOUND_PTR_ARITH]], i64 4
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[BOUND_PTR_ARITH]], align 4, {{!tbaa ![0-9]+}}
// CHECK-NEXT:    [[F2:%.*]] = getelementptr inbounds i8, ptr [[BOUND_PTR_ARITH]], i64 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[F2]], align 4, {{!tbaa ![0-9]+}}
// CHECK-NEXT:    [[F3:%.*]] = getelementptr inbounds i8, ptr [[BOUND_PTR_ARITH]], i64 8
