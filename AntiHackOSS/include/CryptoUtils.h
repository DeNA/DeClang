...
#define CRYPTOUTILS_S(x, n) RORc((x), (n))
#define R1(x, n) (((x)&0xFFFFFFFFUL) >> (n))
#define Sigma0(x)                                                              \
  (CRYPTOUTILS_S(x, 2) ^ CRYPTOUTILS_S(x, 13) ^ CRYPTOUTILS_S(x, 22))
#define Sigma1(x)                                                              \
  (CRYPTOUTILS_S(x, 6) ^ CRYPTOUTILS_S(x, 11) ^ CRYPTOUTILS_S(x, 25))
#define Gamma0(x) (CRYPTOUTILS_S(x, 7) ^ CRYPTOUTILS_S(x, 18) ^ R1(x, 3))
#define Gamma1(x) (CRYPTOUTILS_S(x, 17) ^ CRYPTOUTILS_S(x, 19) ^ R1(x, 10))
