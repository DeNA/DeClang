...
; CHECK-NEXT:    [[TMP10:%.*]] = fmul fast <4 x double> [[WIDE_LOAD7]], [[TMP2]]
; CHECK-NEXT:    [[TMP11:%.*]] = fmul fast <4 x double> [[WIDE_LOAD8]], [[TMP3]]
; CHECK-NEXT:    [[TMP12:%.*]] = fmul fast <4 x double> [[WIDE_LOAD9]], [[TMP4]]
...
; CHECK-NEXT:    [[TMP18:%.*]] = fdiv fast <4 x double> <double 1.000000e+00, double 1.000000e+00, double 1.000000e+00, double 1.000000e+00>, [[BROADCAST_SPLAT15]]
; CHECK-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; CHECK:       vec.epilog.vector.body:
; CHECK-NEXT:    [[INDEX12:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT16:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr inbounds double, ptr [[Y]], i64 [[INDEX12]]
; CHECK-NEXT:    [[WIDE_LOAD13:%.*]] = load <4 x double>, ptr [[TMP19]], align 8, !tbaa [[TBAA3]]
; CHECK-NEXT:    [[TMP20:%.*]] = fmul fast <4 x double> [[WIDE_LOAD13]], [[TMP18]]
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDEX12]]
; CHECK-NEXT:    store <4 x double> [[TMP20]], ptr [[TMP21]], align 8, !tbaa [[TBAA3]]
; CHECK-NEXT:    [[INDEX_NEXT16]] = add nuw i64 [[INDEX12]], 4
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT16]], [[N_VEC11]]
...
; CHECK-NEXT:    [[TMP25:%.*]] = fmul fast double [[T0_PROL]], [[TMP24]]
; CHECK-NEXT:    [[ARRAYIDX2_PROL:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_PROL]]
; CHECK-NEXT:    store double [[TMP25]], ptr [[ARRAYIDX2_PROL]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP26:%.*]] = sub nsw i64 [[INDVARS_IV_PH]], [[WIDE_TRIP_COUNT]]
; CHECK-NEXT:    [[TMP27:%.*]] = icmp ugt i64 [[TMP26]], -8
; CHECK-NEXT:    br i1 [[TMP27]], label [[FOR_END]], label [[FOR_BODY_PREHEADER_NEW:%.*]]
...
; CHECK-NEXT:    [[TMP36:%.*]] = fmul fast double [[T0]], [[TMP28]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    store double [[TMP36]], ptr [[ARRAYIDX2]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP37:%.*]] = fmul fast double [[T0_1]], [[TMP29]]
; CHECK-NEXT:    [[ARRAYIDX2_1:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT]]
; CHECK-NEXT:    store double [[TMP37]], ptr [[ARRAYIDX2_1]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP38:%.*]] = fmul fast double [[T0_2]], [[TMP30]]
; CHECK-NEXT:    [[ARRAYIDX2_2:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_1]]
; CHECK-NEXT:    store double [[TMP38]], ptr [[ARRAYIDX2_2]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP39:%.*]] = fmul fast double [[T0_3]], [[TMP31]]
; CHECK-NEXT:    [[ARRAYIDX2_3:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_2]]
; CHECK-NEXT:    store double [[TMP39]], ptr [[ARRAYIDX2_3]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP40:%.*]] = fmul fast double [[T0_4]], [[TMP32]]
; CHECK-NEXT:    [[ARRAYIDX2_4:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_3]]
; CHECK-NEXT:    store double [[TMP40]], ptr [[ARRAYIDX2_4]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP41:%.*]] = fmul fast double [[T0_5]], [[TMP33]]
; CHECK-NEXT:    [[ARRAYIDX2_5:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_4]]
; CHECK-NEXT:    store double [[TMP41]], ptr [[ARRAYIDX2_5]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP42:%.*]] = fmul fast double [[T0_6]], [[TMP34]]
; CHECK-NEXT:    [[ARRAYIDX2_6:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_5]]
; CHECK-NEXT:    store double [[TMP42]], ptr [[ARRAYIDX2_6]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP43:%.*]] = fmul fast double [[T0_7]], [[TMP35]]
; CHECK-NEXT:    [[ARRAYIDX2_7:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_6]]
; CHECK-NEXT:    store double [[TMP43]], ptr [[ARRAYIDX2_7]], align 8, !tbaa [[TBAA3]]
