...
; CHECK-NEXT:    [[TMP24:%.*]] = mul <4 x i32> [[VEC_IND12]], <i32 196608, i32 196608, i32 196608, i32 196608>
; CHECK-NEXT:    [[TMP25:%.*]] = lshr exact <4 x i32> [[TMP24]], <i32 16, i32 16, i32 16, i32 16>
...
; CHECK-NEXT:    [[VEC_IND_NEXT13]] = add <4 x i32> [[VEC_IND12]], <i32 4, i32 4, i32 4, i32 4>
...
; CHECK-NEXT:    [[DOTSPLATINSERT16:%.*]] = insertelement <8 x i16> poison, i16 [[BC_RESUME_VAL]], i64 0
; CHECK-NEXT:    [[DOTSPLAT17:%.*]] = shufflevector <8 x i16> [[DOTSPLATINSERT16]], <8 x i16> poison, <8 x i32> zeroinitializer
; CHECK-NEXT:    [[DOTSPLATINSERT18:%.*]] = insertelement <8 x i16> poison, i16 [[TMP0]], i64 0
; CHECK-NEXT:    [[DOTSPLAT19:%.*]] = shufflevector <8 x i16> [[DOTSPLATINSERT18]], <8 x i16> poison, <8 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP20:%.*]] = mul <8 x i16> <i16 0, i16 1, i16 2, i16 3, i16 4, i16 5, i16 6, i16 7>, [[DOTSPLAT19]]
; CHECK-NEXT:    [[INDUCTION20:%.*]] = add <8 x i16> [[DOTSPLAT17]], [[TMP20]]
; CHECK-NEXT:    [[TMP21:%.*]] = mul i16 [[TMP0]], 8
; CHECK-NEXT:    [[DOTSPLATINSERT21:%.*]] = insertelement <8 x i16> poison, i16 [[TMP21]], i64 0
; CHECK-NEXT:    [[DOTSPLAT22:%.*]] = shufflevector <8 x i16> [[DOTSPLATINSERT21]], <8 x i16> poison, <8 x i32> zeroinitializer
...
; CHECK-NEXT:    br label [[VEC_EPILOG_VECTOR_BODY:%.*]]
; CHECK:       vec.epilog.vector.body:
; CHECK-NEXT:    [[INDEX15:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], [[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT28:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_IND23:%.*]] = phi <8 x i16> [ [[INDUCTION20]], [[VEC_EPILOG_PH]] ], [ [[VEC_IND_NEXT25:%.*]], [[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP22:%.*]] = add i64 [[INDEX15]], 0
; CHECK-NEXT:    [[TMP23:%.*]] = sub <8 x i16> [[VEC_IND23]], [[BROADCAST_SPLAT27]]
...
; CHECK-NEXT:    [[INDEX_NEXT28]] = add nuw i64 [[INDEX15]], 8
; CHECK-NEXT:    [[VEC_IND_NEXT25]] = add <8 x i16> [[VEC_IND23]], [[DOTSPLAT22]]
; CHECK-NEXT:    [[TMP26:%.*]] = icmp eq i64 [[INDEX_NEXT28]], [[N_VEC8]]
; CHECK-NEXT:    br i1 [[TMP26]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; CHECK:       vec.epilog.middle.block:
; CHECK-NEXT:    [[CMP_N29:%.*]] = icmp eq i64 [[L]], [[N_VEC8]]
