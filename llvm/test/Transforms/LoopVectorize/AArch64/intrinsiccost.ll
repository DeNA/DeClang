...
; CHECK-NEXT:    [[OFFSET_IDX3:%.*]] = shl i64 [[INDEX]], 1
; CHECK-NEXT:    [[NEXT_GEP4:%.*]] = getelementptr i8, ptr [[PDST:%.*]], i64 [[OFFSET_IDX3]]
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[NEXT_GEP]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i16>, ptr [[NEXT_GEP]], align 2
; CHECK-NEXT:    [[WIDE_LOAD6:%.*]] = load <8 x i16>, ptr [[TMP1]], align 2
; CHECK-NEXT:    [[TMP2:%.*]] = call <8 x i16> @llvm.sadd.sat.v8i16(<8 x i16> [[WIDE_LOAD]], <8 x i16> [[BROADCAST_SPLAT]])
; CHECK-NEXT:    [[TMP3:%.*]] = call <8 x i16> @llvm.sadd.sat.v8i16(<8 x i16> [[WIDE_LOAD6]], <8 x i16> [[BROADCAST_SPLAT]])
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[NEXT_GEP4]], i64 16
; CHECK-NEXT:    store <8 x i16> [[TMP2]], ptr [[NEXT_GEP4]], align 2
...
; CHECK-NEXT:    [[IND_END15:%.*]] = getelementptr i8, ptr [[PDST]], i64 [[TMP6]]
; CHECK-NEXT:    [[TMP7:%.*]] = shl nuw nsw i64 [[N_VEC]], 1
; CHECK-NEXT:    [[IND_END12:%.*]] = getelementptr i8, ptr [[PSRC]], i64 [[TMP7]]
...
; CHECK-NEXT:    [[N_VEC8:%.*]] = and i64 [[TMP0]], 4294967292
; CHECK-NEXT:    [[DOTCAST:%.*]] = trunc nuw i64 [[N_VEC8]] to i32
; CHECK-NEXT:    [[IND_END:%.*]] = sub i32 [[BLOCKSIZE]], [[DOTCAST]]
; CHECK-NEXT:    [[TMP8:%.*]] = shl nuw nsw i64 [[N_VEC8]], 1
; CHECK-NEXT:    [[IND_END11:%.*]] = getelementptr i8, ptr [[PSRC]], i64 [[TMP8]]
; CHECK-NEXT:    [[TMP9:%.*]] = shl nuw nsw i64 [[N_VEC8]], 1
; CHECK-NEXT:    [[IND_END14:%.*]] = getelementptr i8, ptr [[PDST]], i64 [[TMP9]]
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT23:%.*]] = insertelement <4 x i16> poison, i16 [[OFFSET]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT24:%.*]] = shufflevector <4 x i16> [[BROADCAST_SPLATINSERT23]], <4 x i16> poison, <4 x i32> zeroinitializer
...
; CHECK-NEXT:    [[WIDE_LOAD22:%.*]] = load <4 x i16>, ptr [[NEXT_GEP19]], align 2
; CHECK-NEXT:    [[TMP10:%.*]] = call <4 x i16> @llvm.sadd.sat.v4i16(<4 x i16> [[WIDE_LOAD22]], <4 x i16> [[BROADCAST_SPLAT24]])
; CHECK-NEXT:    store <4 x i16> [[TMP10]], ptr [[NEXT_GEP21]], align 2
; CHECK-NEXT:    [[INDEX_NEXT25]] = add nuw i64 [[INDEX17]], 4
; CHECK-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_NEXT25]], [[N_VEC8]]
